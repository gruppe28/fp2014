...
public final class DBMethods {
	...
	private DBMethods(){ } // Ensures that you cannot make instances of class.
	...
	public static boolean userExists(String inputUsername){
		try {
			Database db = new Database();
	...
	public static String findPassword(String inputUsername){
		String password = "";
		try {
			Database db = new Database();
